...
function SmartCollect({ width, height, fill }) {
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
      ...
      />
      <Path
        d="M2 21a1 1 0 011-1h18a1 1 0 110 2H3a1 1 0 01-1-1zM8 12.5a1 1 0 10-2 0v5a1 1 0 102 0v-5zM17.026 11.5a1 1 0 011 1v5a1 1 0 11-2 0v-5a1 1 0 011-1zM13.014 12.5a1 1 0 10-2 0v5a1 1 0 002 0v-5z"
        fill={fill}
      />
    </Svg>
  );
