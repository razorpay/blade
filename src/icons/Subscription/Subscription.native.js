  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
      <G clipPath="url(#prefix__clip0)" fill={fill}>
        ...
        <Path d="M8.5 6a1 1 0 100 2h3.23a1.77 1.77 0 011.594 1H9.5a1 1 0 100 2h3.824a1.77 1.77 0 01-1.595 1H8.5a1 1 0 00-.656 1.755c.035.04.073.078.116.113l6 5a1 1 0 001.28-1.536L11.242 14h.487a3.772 3.772 0 003.692-3h.079a1 1 0 100-2h-.079a3.744 3.744 0 00-.362-1h.441a1 1 0 100-2h-7z" />
      </G>
      <Defs>
