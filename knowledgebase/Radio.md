...
function ValidationRadioExample() {
  return (
    <Box gap="spacing.6">
      {/* Error state example */}
      <RadioGroup
        ...
        errorText="Please select an option to proceed"
        name="error-example"
        necessityIndicator="required"
      >
      ...
      {/* Optional indicator example */}
      <RadioGroup
        label="Optional fields example"
        helpText="This selection is optional"
