...
const createBladeSkillToolDescription =
  'Creates the blade usage guidelines skill for AI-assisted code generation. Scaffolds the skill in .agents/skills/blade-usage-guidelines and creates a symlink in .claude/skills for Claude Code support.';
...
const createBladeSkillCore = ({
  ...
  try {
    ...
    if (!existsSync(symlinkPath)) {
      // Relative symlink: .claude/skills/blade-usage-guidelines -> ../../.agents/skills/blade-usage-guidelines
      symlinkSync(
