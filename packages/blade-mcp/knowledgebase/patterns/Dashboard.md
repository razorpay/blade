    ...
    items: [
      {
        icon: LogInIcon,
        title: 'Signup (low)',
        href: '/app/component-density/signup',
      },
      {
        icon: InfoIcon,
        title: 'Transaction Card (medium)',
        href: '/app/component-density/transaction-card',
      },
      {
        icon: LayoutIcon,
        title: 'Developer Console (high)',
        href: '/app/component-density/developer-console',
      },
    ],
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Routes>
            <Route path="/app/example" element={<Example />} />
          </Routes>
        </Box>
      </Box>
    </>
