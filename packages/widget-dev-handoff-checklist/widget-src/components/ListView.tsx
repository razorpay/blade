...
function ListView(
  {
    ...
    return (
    <AutoLayout padding={{horizontal: 4, vertical: 2}} cornerRadius={4} direction="horizontal" spacing={4} width="fill-parent">
      <AutoLayout verticalAlignItems={"center"} horizontalAlignItems={"center"} width={20} height={20}>
        <Text fontSize={14} fontWeight={400} lineHeight={20} fill={'#768EA7'}>→</Text>
      </AutoLayout>
