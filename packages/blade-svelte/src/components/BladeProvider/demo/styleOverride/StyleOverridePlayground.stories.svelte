<script module lang="ts">
  ...
  import StyleOverridePlayground from './StyleOverridePlayground.svelte';

  const { Story } = defineMeta({
    title: 'Guides/Theming/Style Override',
    component: StyleOverridePlayground,
    tags: ['autodocs'],
    parameters: {
      docs: {
        description: {
