...
<Story name="Max">
  {#snippet template(args)}
    <Counter value={args.value ?? 120} max={args.max ?? 99} color={args.color} emphasis="intense" />
  {/snippet}
</Story>
    ...
    <div style="display: flex; flex-direction: column;">
      ...
      >
        {#each colors as color}
          <Counter value={args.value} max={args.max} size="small" {color} emphasis="subtle" />
        {/each}
      </div>
      ...
      >
        {#each colors as color}
          <Counter value={args.value} max={args.max} size="small" {color} emphasis="intense" />
        {/each}
      </div>
    </div>
  {/snippet}
...
<Story name="Medium Size">
  {#snippet template(args)}
    <div style="display: flex; flex-direction: column;">
      ...
      >
        {#each colors as color}
          <Counter value={args.value} max={args.max} size="medium" {color} emphasis="subtle" />
        {/each}
      </div>
      <strong>Intense Emphasis</strong>
      <div
      ...
      >
        {#each colors as color}
          <Counter value={args.value} max={args.max} size="medium" {color} emphasis="intense" />
        {/each}
      </div>
    </div>
  {/snippet}
...
<Story name="Large Size">
  {#snippet template(args)}
    <div style="display: flex; flex-direction: column;">
      ...
      >
        {#each colors as color}
          <Counter value={args.value} max={args.max} size="large" {color} emphasis="subtle" />
        {/each}
      </div>
      <strong>Intense Emphasis</strong>
      <div
      ...
      >
        {#each colors as color}
          <Counter value={args.value} max={args.max} size="large" {color} emphasis="intense" />
        {/each}
      </div>
    </div>
  {/snippet}
