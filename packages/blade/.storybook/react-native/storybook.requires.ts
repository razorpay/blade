...
const normalizedStories = [
  {
    titlePrefix: "",
    directory: "./src",
    files: "**/!(_KitchenSink|*.test|MotionRecipes|BottomNav|ChatInput|DatePicker|DetailedView|DrawerExamples|ListView|ListViewFigmaExample|Menu|Settings|SideNav|RazorSense|TableEditableCellAPI|TableFigmaExample|TableStripedRows|Toast|Typography|ChatMessage|NativeChatMessageDemo|CreationView|TopNav|LightBox|Preview)*.stories.?(ts|tsx|js|jsx)",
