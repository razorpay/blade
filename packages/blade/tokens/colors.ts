...
const colors: color = {
  ...
  neutral: {
    ...
    navyGray: {
      0: `hsla(0, 0, 99%, ${opacities[9]})`,
      50: `hsla(228, 12%, 92%, ${opacities[9]})`,
      100: `hsla(233, 11%, 84%, ${opacities[9]})`,
      200: `hsla(231, 11%, 76%, ${opacities[9]})`,
      300: `hsla(229, 10%, 60%, ${opacities[9]})`,
      400: `hsla(229, 12%, 45%, ${opacities[9]})`,
      500: `hsla(230, 16%, 37%, ${opacities[9]})`,
      600: `hsla(230, 23%, 29%, ${opacities[9]})`,
      700: `hsla(231, 35%, 22%, ${opacities[9]})`,
      800: `hsla(231, 41%, 19%, ${opacities[9]})`,
      900: `hsla(230, 49%, 17%, ${opacities[9]})`,
      1000: `hsla(230, 52%, 16%, ${opacities[9]})`,
      1100: `hsla(231, 54%, 15%, ${opacities[9]})`,
      1200: `hsla(231, 59%, 13%, ${opacities[9]})`,
      1300: `hsla(231, 67%, 10%, ${opacities[9]})`,
    },
    coolGray: {
      0: `hsla(0, 0%, 99%, ${opacities[9]})`,
      50: `hsla(240, 2%, 92%, ${opacities[9]})`,
      100: `hsla(240, 1%, 84%, ${opacities[9]})`,
      200: `hsla(228, 4%, 76%, ${opacities[9]})`,
      300: `hsla(227, 4%, 60%, ${opacities[9]})`,
      400: `hsla(229, 4%, 50%, ${opacities[9]})`,
      500: `hsla(232, 4%, 40%, ${opacities[9]})`,
      600: `hsla(232, 5%, 32%, ${opacities[9]})`,
      700: `hsla(230, 5%, 22%, ${opacities[9]})`,
      800: `hsla(230, 6%, 19%, ${opacities[9]})`,
      900: `hsla(230, 7%, 17%, ${opacities[9]})`,
      1000: `hsla(230, 8%, 15%, ${opacities[9]})`,
      1100: `hsla(231, 11%, 12%, ${opacities[9]})`,
      1200: `hsla(231, 17%, 8%, ${opacities[9]})`,
      1300: `hsla(228, 5%, 4%, ${opacities[9]})`,
    },
  },
};
