...
> Before starting to use Blade make sure you have followed the [installation guide](/story/guides-installation--docs&globals=measureEnabled:false#%EF%B8%8F-installation) and installed all the dependencies like `styled-components`, `fonts` etc.
