...
- Download fonts from <a href="https://github.com/razorpay/blade/blob/rebranding/typography-documentation/packages/blade/fonts/blade-fonts-react-native.zip">blade-fonts-react-native.zip</a> and unzip.

- #### For iOS

  - Copy all font files from `ios-fonts` directory to `<project_root>/public/fonts` (**create the directory if it doesn't exist**)
