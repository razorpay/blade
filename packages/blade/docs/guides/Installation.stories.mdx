...
<Tabs marginTop="spacing.8" variant="bordered" orientation="horizontal">
  ...
  <TabPanel value="basic">
    ...
    <StepGroup orientation="vertical" size="medium">
      <StepItem
        title="1. Install blade as a dependency."
      >
        <Text>Blade has a peer dependency on a few libraries, you can skip adding it if you already have it installed in your project.</Text>
      ...
      <StepItem
        title="2. Add ReactNative Dependencies [Optional for web projects]"
      >
        ```shell
  ...
  <TabPanel value="ts">
    ...
    If you're using TypeScript in your project, firstly make sure you have `@types/styled-components` installed in your project.
    ...
    To get ReactNative specific type hints for blade you can switch the `moduleSuffixes` in your `tsconfig.json` to include `.native` files.
