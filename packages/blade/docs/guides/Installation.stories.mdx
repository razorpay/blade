...
3. For **React Native** projects you need to do additional setup for the peer dependencies: 
    ...
    - react-native-reanimated
      - Follow [this guide](https://docs.swmansion.com/react-native-reanimated/docs/fundamentals/getting-started/) to install it on Android & iOS which is required by Blade.

  And finally also run `pod install` command so that blade's RN dependencies are linked to your project: 
