...
<div style={{ height: 500, marginTop: 30 }}>
  <RecipeSandbox title="react-router with Blade Link" codesandboxId="blade-link-react-router-v5-rcrdn8" activeFile="/src/BladeRouterLink.tsx" view="editor" />
</div>
...
<div style={{ height: 500, marginTop: 30 }}>
  <RecipeSandbox title="react-router with Blade Link" codesandboxId="blade-link-react-router-v6-2w5f9k" activeFile="/src/BladeRouterLink.tsx" view="editor" />
</div>
...
<div style={{ height: 500, marginTop: 30 }}>
  <RecipeSandbox title="react-router with Blade Tab" codesandboxId="blade-tab-react-router-v6-7g8nwc" activeFile="/src/TabItemLink.tsx" view="editor" />
</div>
