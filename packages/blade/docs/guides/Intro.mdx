...
<p style={{ textAlign: 'center' }}>
  <img height="80px" width="300px" alt="Blade Design System Logo" src="https://raw.githubusercontent.com/razorpay/blade/00a200a8f53c1abff99d81a73fbdcbd12a6d0dca/branding/blade-original.min.svg" />
</p>
...
<div style={{ display: 'flex', alignContent: 'center', justifyContent: 'center', gap: '12px' }}>
  <a href="https://npmjs.org/package/@razorpay/blade">
    <img alt="Blade Latest Version" src="https://img.shields.io/github/package-json/v/razorpay/blade?style=for-the-badge&labelColor=322&logo=npm&label=@razorpay/Blade&color=darkred&filename=packages%2Fblade%2Fpackage.json" />
  </a>
...
### [@razorpay/blade-svelte](https://github.com/razorpay/blade/tree/master/packages/blade-svelte#readme)

This package brings Blade components to Svelte applications. It is currently under **active development** and new components are being added progressively.
