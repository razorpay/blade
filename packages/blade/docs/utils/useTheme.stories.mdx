...
`useTheme` is a custom React hook provided by the `@razorpay/blade/components`  that allows you to access the current theme and color scheme of your application.
