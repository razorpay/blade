...
import { useTheme, BladeProvider, Box } from '../../src//components';
import { bladeTheme } from '../../src/tokens';
import { makeTypographySize } from '../../src/utils';
import FigmaEmbed from '../../src/utils/storybook/FigmaEmbed';
...
<Box paddingY="spacing.6">
  <FigmaEmbed src="https://www.figma.com/file/5BZsOpNjbUHqgVh850yPBW/%5BResearch%5D-Typography-%26-Spacing-Refresh?type=design&node-id=101-99618&mode=design&t=KdVVWtntizpKmsBt-0" />
</Box>
