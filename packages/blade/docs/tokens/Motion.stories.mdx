          ...
          {Object.entries(theme.motion.easing.standard).map(([key, value]) => (
            <tr key={key}>
              ...
              <td style={{ width: '150px' }}>
                <MovingDiv theme={theme} easing={theme.motion.easing.standard[key]} />
              </td>
            </tr>
          ))}
        </tbody>
        ...
        <tbody>
          {Object.entries(theme.motion.easing.entrance).map(([key, value]) => (
            <tr key={key}>
              ...
              <td>{value}</td>
              <td style={{ width: '150px' }}>
                <MovingDiv theme={theme} easing={theme.motion.easing.entrance[key]} />
              </td>
            </tr>
          ))}
        </tbody>
        ...
        <tbody>
          {Object.entries(theme.motion.easing.exit).map(([key, value]) => (
            <tr key={key}>
              ...
              <td>{value}</td>
              <td style={{ width: '150px' }}>
                <MovingDiv theme={theme} easing={theme.motion.easing.exit[key]} />
              </td>
            </tr>
          ))}
        </tbody>
...
1. Ensure you've followed all the steps under ["Guides/Usage"](https://master--61c19ee8d3d282003ac1d81c.chromatic.com//?path=/story/guides-usage--docs&globals=measureEnabled:false) to setup your theme with `<BladeProvider>`
