import { DayOfWeek, DateValue, DatePickerProps as MantineDatePickerProps, DatesRangeValue } from '@mantine/dates';
import { BaseInputProps } from '../Input/BaseInput';
import { TextInputProps } from '../Input/TextInput';
import { FormInputValidationProps } from '../Form';
...
type CalendarProps<SelectionType extends DateSelectionType> = Pick<MantineDatePickerProps<SelectionType extends 'single' ? 'default' : 'range'>, MantineInternalProps | 'value' | 'defaultValue' | 'onChange' | 'onMonthSelect' | 'onYearSelect'> & {
    /**
...
type DatePickerInputProps = DatePickerCommonInputProps & (DatePickerRangeInputProps | DatePickerSingleInputProps) & {
    format: string;
    placeholder?: string;
...
export type { CalendarProps, DatePickerProps, PickerType, DatesRangeValue, DateValue, DateSelectionType, DatePickerInputProps, DatePickerFilterChipProps, FilterChipDatePickerProps, DateInputProps, };
