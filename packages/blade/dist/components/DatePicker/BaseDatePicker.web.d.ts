...
import { DatesRangeValue, DatePickerProps, DateSelectionType } from './types';
import { StyledPropsBlade } from '../Box/styledProps';
import { DataAnalyticsAttribute } from '../../utils/types';
declare const BaseDatePicker: <Type extends DateSelectionType = "single">({ selectionType, allowSingleDateInRange, value, defaultValue, onChange, onApply, presets, isOpen, defaultIsOpen, onOpenChange, label, labelPosition, accessibilityLabel, errorText, helpText, isDisabled, isRequired, successText, validationState, size, autoFocus, necessityIndicator, name, defaultPicker, picker, onPickerChange, zIndex, format, inputPlaceHolder, inputElementType, onClearButtonClick, labelSuffix, labelTrailing, showFooterActions, ...props }: Omit<import('./types').CalendarProps<Type>, "onMouseLeave" | "__onDayMouseEnter" | "__onDayClick" | "getDayProps" | "getYearControlProps" | "getMonthControlProps"> & Omit<{
    labelPosition?: "left" | "top" | undefined;
    inputRef: React.Ref<any>;
    referenceProps: any;
} & Pick<import('../Input/TextInput/TextInput').TextInputProps, "size" | "autoFocus" | "isDisabled" | "accessibilityLabel" | "necessityIndicator" | "labelSuffix" | "labelTrailing" | "isRequired"> & import('../Form').FormInputValidationProps, "name" | "labelPosition" | "errorText" | "successText" | "helpText" | "inputRef" | "referenceProps"> & {
    ...
    onApply?: (Type extends "single" ? (value: import('@mantine/dates').DateValue) => void : (value: DatesRangeValue) => void) | undefined;
    labelPosition?: "left" | "top" | undefined;
