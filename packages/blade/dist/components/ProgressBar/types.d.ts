...
import { DelayString, DurationString, EasingString } from '../../tokens/global';
...
type CircularProgressBarFilledProps = Pick<ProgressBarProps, 'size' | 'label' | 'showPercentage' | 'type'> & {
    isMeter: boolean;
    backgroundColor: string;
    fillColor: string;
