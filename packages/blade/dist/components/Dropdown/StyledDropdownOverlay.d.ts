declare const StyledDropdownOverlay: import('styled-components').StyledComponent<"div", import('styled-components').DefaultTheme, Omit<Partial<import('../Box/BaseBox/types/spacingTypes').PaddingProps & import('../Box/BaseBox/types/spacingTypes').MarginProps & {
    ...
    isInBottomSheet?: boolean | undefined;
}, never>;
