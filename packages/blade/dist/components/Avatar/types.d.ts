import { HTMLAttributeReferrerPolicy, ImgHTMLAttributes, default as React } from 'react';
...
export type { AvatarGroupProps, AvatarProps, StyledAvatarProps, AvatarGroupContextType, AvatarButtonProps, };
