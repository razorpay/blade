declare const StyledAvatarButton: import('styled-components').StyledComponent<"button", import('styled-components').DefaultTheme, {
    size?: ("xsmall" | "small" | "medium" | "large" | "xlarge") | undefined;
    variant?: "circle" | "square" | undefined;
    color?: import('../../tokens/theme/theme').FeedbackColors | "primary" | undefined;
    ...
    bottomAddon?: import('..').IconComponent | undefined;
    topAddon?: import('react').ReactElement<any, string | import('react').JSXElementConstructor<any>> | undefined;
    testID?: string | undefined;
} & import('../types').BladeCommonEvents & Partial<Omit<import('../Box/BaseBox/types/spacingTypes').MarginProps & Pick<import('../Box/BaseBox/types/propsTypes').FlexboxProps, "alignSelf" | "flexWrap" | "justifySelf" | "order" | "placeSelf"> & {
