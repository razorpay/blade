import { UseFloatingReturn, UseInteractionsReturn, useListItem } from '@floating-ui/react';
import { default as React } from 'react';
import { BaseFooterProps } from '../BaseHeaderFooter/BaseFooter';
import { BaseHeaderProps } from '../BaseHeaderFooter/BaseHeader';
import { BaseMenuItemProps } from '../BaseMenu/types';
...
type UseFloatingMenuReturnType = Pick<UseInteractionsReturn, 'getFloatingProps' | 'getItemProps' | 'getReferenceProps'> & Pick<UseFloatingReturn<HTMLButtonElement>, 'context' | 'floatingStyles' | 'refs'> & {
...
export type { MenuItemProps, MenuOverlayProps, MenuFooterProps, MenuHeaderProps, MenuProps, MenuContextType, UseFloatingMenuProps, UseFloatingMenuReturnType, };
