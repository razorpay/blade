...
type StyledButtonGroupProps = Pick<ButtonGroupProps, 'isDisabled' | 'color' | 'variant' | 'isFullWidth'>;
type ButtonGroupContextType = Pick<ButtonGroupProps, 'isDisabled' | 'isFullWidth' | 'size' | 'color' | 'variant'>;
