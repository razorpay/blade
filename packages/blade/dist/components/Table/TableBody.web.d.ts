...
import { TableProps, TableBodyProps, TableRowProps, TableCellProps, TableBackgroundColors, VirtualizedWrapperProps } from './types';
declare const TableBody: <Item>({ children, ...rest }: TableBodyProps<Item>) => React.ReactElement;
export declare const StyledCell: import('styled-components').StyledComponent<React.FC<import('@table-library/react-table-library/table').CellProps>, import('styled-components').DefaultTheme, {
    $backgroundColor: TableBackgroundColors;
    gridRow?: string | undefined;
}, never>;
export declare const CellWrapper: import('styled-components').StyledComponent<"div", import('styled-components').DefaultTheme, Omit<Partial<import('../Box/BaseBox/types/spacingTypes').PaddingProps & import('../Box/BaseBox/types/spacingTypes').MarginProps & {
...
} & import('../Box/BaseBox/types/propsTypes').FlexboxProps & {
...
} & import('../Box/BaseBox/types/responsiveTypes').MakeObjectResponsive<{
    ...
    lineHeight: import('../Box/BaseBox/types/spacingTypes').SpacingValueType | {
        readonly base?: import('../Box/BaseBox/types/spacingTypes').SpacingValueType | undefined;
        readonly xs?: import('../Box/BaseBox/types/spacingTypes').SpacingValueType | undefined;
        readonly s?: import('../Box/BaseBox/types/spacingTypes').SpacingValueType | undefined;
        readonly m?: import('../Box/BaseBox/types/spacingTypes').SpacingValueType | undefined;
    ...
    id?: string | undefined;
    tabIndex?: number | undefined;
}> & import('../types').BladeCommonEvents & {
    $rowDensity: NonNullable<TableProps<unknown>['rowDensity']>;
    showStripedRows?: boolean | undefined;
    hasPadding?: boolean | undefined;
    textAlign?: TableCellProps['textAlign'];
}, never>;
declare const TableCell: ({ children, textAlign, _hasPadding, gridColumnStart, gridColumnEnd, gridRowStart, gridRowEnd, ...rest }: TableCellProps) => React.ReactElement;
declare const TableRow: <Item>({ children, item, isDisabled, onHover, onClick, hoverActions, testID, ...rest }: TableRowProps<Item>) => React.ReactElement;
declare const TableVirtualizedWrapper: <Item>({ headerHeight, rowHeight, children, }: VirtualizedWrapperProps) => React.ReactElement;
