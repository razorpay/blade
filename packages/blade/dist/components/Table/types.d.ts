...
import { TableNode as TableLibraryTableNode } from '@table-library/react-table-library/types/table';
...
export type { TableProps, Identifier, TableNode, TableData, TableHeaderProps, TableHeaderRowProps, TableHeaderCellProps, TableBodyProps, TableRowProps, TableCellProps, TableEditableCellProps, TableEditableDropdownCellProps, TableFooterProps, TableFooterRowProps, TableFooterCellProps, TablePaginationProps, TableToolbarProps, TableToolbarActionsProps, TableBackgroundColors, TablePaginationType, TablePaginationCommonProps, VirtualizedWrapperProps, RowHeightType, TableCellGridSpanningProps, };
