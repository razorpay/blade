...
declare const BottomNavItem: ({ title, href, rel, target, as, isActive, onClick, icon: Icon, testID, ...rest }: BottomNavItemProps) => React.ReactElement;
declare const BottomNav: React.ForwardRefExoticComponent<{
...
}, "visibility">, "__brand__">> & import('../../utils/types').TestID & import('../../utils/types').DataAnalyticsAttribute & React.RefAttributes<BladeElementRef>>;
