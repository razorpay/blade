...
declare const TopNav: React.ForwardRefExoticComponent<{
    children: React.ReactNode;
} & Pick<Partial<import('../Box/BaseBox/types/spacingTypes').PaddingProps & import('../Box/BaseBox/types/spacingTypes').MarginProps & {
    ...
    id?: string | undefined;
} & TestID & DataAnalyticsAttribute>, "width" | "backgroundColor" | "bottom" | "left" | "paddingBottom" | "paddingLeft" | "paddingRight" | "paddingTop" | "position" | "right" | "top" | "zIndex" | "padding" | `data-analytics-${string}` | "paddingX" | "paddingY"> & TestID & Partial<Omit<import('../Box/BaseBox/types/spacingTypes').MarginProps & Pick<import('../Box/BaseBox/types/propsTypes').FlexboxProps, "alignSelf" | "flexWrap" | "justifySelf" | "order" | "placeSelf"> & {
    bottom: import('../Box/BaseBox/types/spacingTypes').SpacingValueType | {
        readonly base?: import('../Box/BaseBox/types/spacingTypes').SpacingValueType | undefined;
        readonly xs?: import('../Box/BaseBox/types/spacingTypes').SpacingValueType | undefined;
        readonly s?: import('../Box/BaseBox/types/spacingTypes').SpacingValueType | undefined;
