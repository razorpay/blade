...
import { DataAnalyticsAttribute, BladeElementRef, StringChildrenType, TestID } from '../../utils/types';
type BadgeProps = {
    /**
...
} & TestID & Partial<Omit<import('../Box/BaseBox/types/spacingTypes').MarginProps & Pick<import('../Box/BaseBox/types/propsTypes').FlexboxProps, "alignSelf" | "flexWrap" | "justifySelf" | "order" | "placeSelf"> & {
...
}, "visibility">, "__brand__">> & DataAnalyticsAttribute & React.RefAttributes<BladeElementRef>>;
