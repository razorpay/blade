...
declare const Accordion: React.ForwardRefExoticComponent<{
    ...
    variant?: import('./types').AccordionVariantType | undefined;
    ...
    children: ReactElement<any, string | React.JSXElementConstructor<any>> | ReactElement<any, string | React.JSXElementConstructor<any>>[];
