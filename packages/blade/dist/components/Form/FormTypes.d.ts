...
export type FormInputHandleOnEvent = ({ name, value, }: {
    name?: string;
    value?: React.ChangeEvent<HTMLInputElement> | string;
}) => void;
export type FormInputOnEvent = ({ name, value, rawValue, }: {
    name?: string;
    value?: string;
    rawValue?: string;
}) => void;
export type FormInputHandleOnKeyDownEvent = ({ name, key, code, event, }: FormInputOnKeyDownEvent) => void;
