...
import { BladeElementRef, DataAnalyticsAttribute, TestID } from '../../utils/types';
import { MotionMetaProp } from '../BaseMotion';
type OnChange = ({ isChecked, event, value, }: {
    isChecked: boolean;
...
}, "visibility">, "__brand__">> & MotionMetaProp & React.RefAttributes<BladeElementRef>>;
