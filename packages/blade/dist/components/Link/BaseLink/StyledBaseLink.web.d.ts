declare const StyledLink: import('styled-components').StyledComponent<"button", import('styled-components').DefaultTheme, {
    variant: "anchor" | "button" | undefined;
    as: "a" | "button";
    ...
    onBlur?: import("../../../utils/platform/platform").Platform.Select<{
        native: (event: import('react-native/types').GestureResponderEvent) => void;
        web: (event: import('react').FocusEvent<HTMLButtonElement, Element>) => void;
    }> | undefined;
    onMouseLeave?: import("../../../utils/platform/platform").Platform.Select<{
        native: (event: import('react-native/types').GestureResponderEvent) => void;
        web: (event: import('react').MouseEvent<HTMLButtonElement, MouseEvent>) => void;
    }> | undefined;
    onKeyDown?: import("../../../utils/platform/platform").Platform.Select<{
        native: (event: import('react-native/types').GestureResponderEvent) => void;
        web: (event: import('react').KeyboardEvent<HTMLButtonElement>) => void;
    }> | undefined;
    focusRingColor: string;
    disabled: boolean;
    motionDuration: "duration.moderate" | "duration.2xquick" | "duration.xquick" | "duration.quick" | "duration.xmoderate" | "duration.gentle" | "duration.xgentle" | "duration.2xgentle";
    motionEasing: "easing.linear" | "easing.entrance" | "easing.exit" | "easing.standard" | "easing.emphasized" | "easing.overshoot" | "easing.shake";
    setCurrentInteraction: import('react').Dispatch<import('react').SetStateAction<import('../../../utils/useInteraction').ActionStates>>;
...
}, "visibility">, "__brand__">> & Omit<import('../../types').BladeCommonEvents, "onMouseLeave" | "onBlur">, never>;
