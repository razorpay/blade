...
declare const BottomSheetContext: React.Context<BottomSheetContextProps>;
declare const useBottomSheetContext: () => BottomSheetContextProps;
...
declare const BottomSheetAndDropdownGlueContext: React.Context<BottomSheetAndDropdownGlueContext>;
/**
 ...
 */
declare const useBottomSheetAndDropdownGlue: () => BottomSheetAndDropdownGlueContext;
export type { BottomSheetContextProps };
export { BottomSheetContext, useBottomSheetContext, BottomSheetAndDropdownGlueContext, useBottomSheetAndDropdownGlue, };
