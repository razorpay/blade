...
declare const Skeleton: React.ForwardRefExoticComponent<Partial<Omit<import('../Box/BaseBox/types/spacingTypes').MarginProps & Pick<import('../Box/BaseBox/types/propsTypes').FlexboxProps, "alignSelf" | "flexWrap" | "justifySelf" | "order" | "placeSelf"> & {
...
}, "visibility">, "__brand__">> & Pick<import('../Box/BaseBox/types/propsTypes').BaseBoxProps, "width" | "height" | "maxHeight" | "maxWidth" | "minHeight" | "minWidth" | "borderRadius"> & Partial<import('../Box/BaseBox/types/propsTypes').FlexboxProps> & {
