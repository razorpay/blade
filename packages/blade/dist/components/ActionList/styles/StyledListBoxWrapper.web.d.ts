...
declare const StyledListBoxWrapper: import('styled-components').StyledComponent<"div", import('styled-components').DefaultTheme, Omit<Partial<import('../../Box/BaseBox/types/spacingTypes').PaddingProps & import('../../Box/BaseBox/types/spacingTypes').MarginProps & {
    ...
    id?: string | undefined;
    tabIndex?: number | undefined;
}> & import('../../types').BladeCommonEvents & Partial<SectionListProps<any, any>> & {
