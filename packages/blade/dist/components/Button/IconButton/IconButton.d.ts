...
} & DataAnalyticsAttribute & BladeCommonEvents & Partial<Omit<import('../../Box/BaseBox/types/spacingTypes').MarginProps & Pick<import('../../Box/BaseBox/types/propsTypes').FlexboxProps, "alignSelf" | "flexWrap" | "justifySelf" | "order" | "placeSelf"> & {
