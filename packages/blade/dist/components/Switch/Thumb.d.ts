declare const Thumb: import('styled-components').StyledComponent<"div", import('styled-components').DefaultTheme, Omit<Partial<import('../Box/BaseBox/types/spacingTypes').PaddingProps & import('../Box/BaseBox/types/spacingTypes').MarginProps & {
...
} & Pick<import('./types').SwitchProps, "size" | "isChecked">, never>;
export { Thumb };
