...
import { FormInputHandleOnEvent } from '../../Form';
import { FormInputHandleOnClickEvent, FormInputHandleOnKeyDownEvent, FormInputOnClickEvent } from '../../Form/FormTypes';
...
export type BaseInputWrapperProps = Pick<BaseInputProps, 'isDisabled' | 'validationState' | 'showAllTags' | 'maxTagRows' | 'isDropdownTrigger'> & {
    isFocused?: boolean;
...
export type StyledBaseInputProps = {
    ...
    hasLeadingDropdown?: boolean;
} & Pick<BaseInputProps, 'as' | 'numberOfLines' | 'id' | 'name' | 'type' | 'placeholder' | 'defaultValue' | 'value' | 'isDisabled' | 'isRequired' | 'validationState' | 'leadingIcon' | 'prefix' | 'trailingInteractionElement' | 'onTrailingInteractionElementClick' | 'leadingInteractionElement' | 'suffix' | 'trailingIcon' | 'maxCharacters' | 'textAlign' | 'autoFocus' | 'keyboardType' | 'keyboardReturnKeyType' | 'autoCompleteSuggestionType' | 'hasPopup' | 'popupId' | 'isPopupExpanded' | 'shouldIgnoreBlurAnimation' | 'autoCapitalize' | 'isDropdownTrigger' | 'tabIndex'>;
