import { StringWithAutocomplete } from '../../utils/types';
import { Border, Breakpoints, Motion, Spacing, TypographyWithPlatforms, ElevationWithColorModes } from '../global';
...
export type BorderRadiusValues = `${Border['radius'][Exclude<keyof Border['radius'], 'round'>]}px` | `${Border['radius'][Extract<keyof Border['radius'], 'round'>]}`;
export declare const colorSchemeNamesInput: ColorSchemeNamesInput[];
export {};
