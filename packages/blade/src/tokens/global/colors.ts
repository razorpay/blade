...
export const colors: Color = {
  ...
  neutral: {
    ...
    blueGrayDark: {
      ...
      50: `hsla(220, 22%, 92%, ${opacity[12]})`,
      100: `hsla(214, 20%, 84%, ${opacity[12]})`,
      200: `hsla(214, 17%, 76%, ${opacity[12]})`,
      300: `hsla(216, 18%, 62%, ${opacity[12]})`,
      400: `hsla(215, 20%, 43%, ${opacity[12]})`,
      500: `hsla(216, 22%, 36%, ${opacity[12]})`,
      600: `hsla(216, 24%, 31%, ${opacity[12]})`,
      700: `hsla(216, 27%, 24%, ${opacity[12]})`,
      800: `hsla(217, 27%, 21%, ${opacity[12]})`,
      900: `hsla(218, 26%, 18%, ${opacity[12]})`,
      1000: `hsla(217, 27%, 15%, ${opacity[12]})`,
      1100: `hsla(216, 30%, 13%, ${opacity[12]})`,
      1200: `hsla(215, 37%, 10%, ${opacity[12]})`,
      1300: `hsla(214, 44%, 7%, ${opacity[12]})`,
      a25: `hsla(214, 20%, 84%, undefined)`,
      a50: `hsla(214, 20%, 84%, ${opacity[1]})`,
      a75: `hsla(214, 20%, 84%, ${opacity[2]})`,
      a100: `hsla(214, 20%, 84%, ${opacity[3]})`,
      a200: `hsla(214, 20%, 84%, ${opacity[5]})`,
      a400: `hsla(214, 20%, 84%, ${opacity[8]})`,
    },
    ashGrayLight: {
      0: `hsla(0, 0%, 100%, ${opacity[12]})`,
