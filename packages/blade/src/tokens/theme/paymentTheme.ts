...
import _globalColors, { Color } from '~tokens/global/colors';
import typography from '~tokens/global/typography';
import motion from '~tokens/global/motion';

function getPaymentTheme(globalColors: Color): ThemeTokens {
  const brandColors = {
    primary: {
  ...
  const onLightActions = {
    background: {
      ...
      tertiary: {
        ...
        hover: brandColors.gray[200], // 200
        focus: brandColors.gray[300], // 300
    ...
    border: {
      ...
      tertiary: {
        ...
        hover: brandColors.gray[300],
        focus: brandColors.gray[300],
        active: brandColors.gray[300],
        disabled: brandColors.gray[300],
      },
    },
    text: {
...
export { getPaymentTheme };

export default getPaymentTheme(_globalColors);
