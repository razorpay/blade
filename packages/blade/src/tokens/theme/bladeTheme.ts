...
const colors: ColorsWithModes = {
  onLight: {
    ...
    elevation: {
      lowRaised: `hsla(212, 39%, 16%, )`,
      midRaised: `hsla(212, 39%, 16%, )`,
      highRaised: `hsla(212, 39%, 16%, )`,
    },
    transparent: `hsla(0, 0%, 100%, )`,
  },
  onDark: {
    interactive: {
      icon: {
    ...
    elevation: {
      lowRaised: `hsla(211, 53%, 10%, )`,
      midRaised: `hsla(211, 53%, 10%, )`,
      highRaised: `hsla(211, 53%, 10%, )`,
    },
    transparent: `hsla(0, 0%, 100%, )`,
  },
};
