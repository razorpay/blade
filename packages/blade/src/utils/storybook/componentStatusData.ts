...
const componentData: ComponentStatusDataType = [
  ...
  },
  {
    ...
    description: 'Elevate component for adding elevation motion effects to elements.',
    platform: 'all',
  },
  {
    name: 'BottomNav',
    status: 'released',
    releasedIn: '11.34.0',
    storybookLink: 'Components/Navigation/BottomNav',
    description: 'BottomNav component for mobile navigation at the bottom of the screen.',
    platform: 'all',
  },
  {
    name: 'TableEditableDropdownCell',
    status: 'released',
    releasedIn: '11.26.0',
    storybookLink: 'Components/Table/TableEditableDropdownCell',
    description: 'TableEditableDropdownCell component for editable dropdown cells in tables.',
    platform: 'all',
  },
  {
    name: 'Stagger',
    status: 'released',
    releasedIn: '12.0.0',
    storybookLink: 'Motion/Stagger',
    description: 'Stagger component for creating staggered animation effects.',
    platform: 'all',
  },
  {
    name: 'AnimateInteractions',
    status: 'released',
    releasedIn: '12.0.0',
    storybookLink: 'Motion/AnimateInteractions',
    description: 'AnimateInteractions component for handling interaction-based animations.',
    platform: 'all',
  },
  {
    ...
    status: 'released',
    releasedIn: '11.24.0',
    storybookLink: 'Components/Table/TableEditableCell',
    description: 'TableEditableCell component for editable cells in tables.',
    platform: 'all',
  },
  {
    name: 'TopNav',
    status: 'released',
    releasedIn: '11.23.0',
    storybookLink: 'Components/Navigation/TopNav',
    description: 'TopNav component for top navigation bar.',
    platform: 'all',
  },
  {
    name: 'Menu',
    ...
    releasedIn: '11.22.0',
    storybookLink: 'Components/Menu',
    description: 'Menu component for dropdown menus and context menus.',
    platform: 'all',
  },
  {
    name: 'SideNav',
    status: 'released',
    releasedIn: '11.21.0',
    storybookLink: 'Components/Navigation/SideNav',
    description: 'SideNav component for side navigation with support for multiple levels.',
    platform: 'all',
  },
  {
    name: 'DatePicker',
    status: 'released',
    releasedIn: '11.19.0',
    storybookLink: 'Components/Input/DatePicker',
    description: 'DatePicker component for selecting dates and date ranges.',
    platform: 'all',
  },
  {
    name: 'SearchInput',
    ...
    releasedIn: '11.18.0',
    storybookLink: 'Components/Input/SearchInput',
    description: 'SearchInput component for search functionality.',
    platform: 'all',
  },
  {
    name: 'Avatar',
    status: 'released',
    releasedIn: '11.18.0',
    storybookLink: 'Components/Avatar',
    description: 'Avatar component for displaying user avatars.',
    platform: 'all',
  },
  {
    name: 'AvatarGroup',
    ...
    description: 'AvatarGroup component for displaying multiple avatars in a group.',
    platform: 'all',
  },
  {
    name: 'StepGroup',
    ...
    releasedIn: '11.15.0',
    storybookLink: 'Components/StepGroup',
    description: 'StepGroup component for displaying step-by-step progress.',
    platform: 'all',
  },
];
