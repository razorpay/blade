 ...
 *
 * Code from: https://github.com/adobe/react-spectrum/blob/main/packages/%40react-aria/overlays/src/usePreventScroll.ts
 */
 ...
 */
function usePreventScroll(options: PreventScrollOptions = {}) {
