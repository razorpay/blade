...
// TODO: uncomment once TextInput is done
    ...
    <CheckoutShell>
      <Box padding="spacing.4">
        ...
        <Box display="flex" gap="spacing.6" marginTop="spacing.8">
          <Box flex="2">{/* <TextInput label="Card Number" /> */}</Box>
          <Box flex="1">{/* <TextInput label="Expiry" /> */}</Box>
        </Box>
        <Box display="flex" gap="spacing.6" marginTop="spacing.8">
          <Box flex="2">{/* <TextInput label="Card Holder's Name" /> */}</Box>
          <Box flex="1">{/* <PasswordInput label="CVV" /> */}</Box>
        </Box>
