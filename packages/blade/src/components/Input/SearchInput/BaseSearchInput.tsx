...
type BaseSearchInputCommonProps = Pick<
  BaseInputProps,
  | 'label'
  | 'accessibilityLabel'
  | 'labelPosition'
...
> & {
  ...
  /**
   * Decides whether to show a filter search input.
   *
   * @default false
   */
...
*/
type BaseSearchInputPropsWithA11yLabel = {
  /**
...
*/
type BaseSearchInputPropsWithLabel = {
  /**
   * Label to be shown for the input field
   */
  label: string;
...
type BaseSearchInputProps = (BaseSearchInputPropsWithA11yLabel | BaseSearchInputPropsWithLabel) &
  BaseSearchInputCommonProps;
...
const BaseSearchInput: React.ForwardRefRenderFunction<BladeElementRef, BaseSearchInputProps> = (
  {
    label,
    accessibilityLabel,
    labelPosition = 'top',
