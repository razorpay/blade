...
import { useFilterChipGroupContext } from './FilterChipGroupContext.native';
...
import { useListViewFilterContext } from '~components/ListView/ListViewFiltersContext.native';
import { useFirstRender } from '~utils/useFirstRender';

type FilterChipSelectInputProps = Pick<
  BaseFilterChipProps,
  'value' | 'label' | 'testID' | 'onClick' | 'selectionType' | 'onBlur'
> & {
