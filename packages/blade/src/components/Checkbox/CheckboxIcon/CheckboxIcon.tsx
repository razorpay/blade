...
const CheckboxIcon = ({
  ...
  const defaultIconColor = getIn(theme, 'colors.interactive.background.staticWhite.disabled');
  const disabledIconColor = getIn(theme, 'colors.interactive.border.gray.highlighted');
