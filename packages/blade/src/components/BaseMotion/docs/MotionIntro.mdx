...
<Move>
  <Box>
    ...
    <Alert title="Note" description="If you've followed Step 3 from our Installation Guide and already have Motion React setup, you can skip this-" isFullWidth isDismissible={false} marginBottom="spacing.5" />
