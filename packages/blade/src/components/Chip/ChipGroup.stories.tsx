    ...
    <Box display="flex" flexDirection="column" gap="spacing.8">
      <Box>
        ...
        <ChipGroupComponent
          ...
          {...args}
        >
          <ChipComponent value="basic">Basic</ChipComponent>
          <ChipComponent value="standard">Standard</ChipComponent>
          <ChipComponent value="premium">Premium</ChipComponent>
        </ChipGroupComponent>
      </Box>

      <Box>
        <Heading size="medium" marginBottom="spacing.4">
          Multiple Selection — Full Width
        </Heading>
        <ChipGroupComponent
          isFullWidth
          selectionType="multiple"
          ...
          {...args}
        >
          <ChipComponent value="payments">Payments</ChipComponent>
          <ChipComponent value="invoices">Invoices</ChipComponent>
          <ChipComponent value="subscriptions">Subscriptions</ChipComponent>
          <ChipComponent value="payouts">Payouts</ChipComponent>
        </ChipGroupComponent>
      </Box>
      ...
      <Box>
        ...
        {sizes.map((size) => (
          <Box key={size} marginBottom="spacing.5">
            ...
            <ChipGroupComponent
              ...
              selectionType="single"
              defaultValue="basic"
              accessibilityLabel={`Select plan (${size})`}
              size={size}
            >
              <ChipComponent value="basic">Basic</ChipComponent>
              <ChipComponent value="standard">Standard</ChipComponent>
      ...
      <Box>
        <Heading size="medium" marginBottom="spacing.4">
          Comparison: Default vs Full Width
        </Heading>
        <Box marginBottom="spacing.4">
          <Text size="medium" weight="semibold" marginBottom="spacing.2">
            Default (isFullWidth=false)
          </Text>
          <ChipGroupComponent
            selectionType="single"
            defaultValue="basic"
            accessibilityLabel="Default width chips"
          >
            <ChipComponent value="basic">Basic</ChipComponent>
            <ChipComponent value="standard">Standard</ChipComponent>
            <ChipComponent value="premium">Premium</ChipComponent>
        ...
        <Box>
          <Text size="medium" weight="semibold" marginBottom="spacing.2">
            Full Width (isFullWidth=true)
          </Text>
          <ChipGroupComponent
            isFullWidth
            selectionType="single"
            defaultValue="basic"
            accessibilityLabel="Full width chips"
          >
            <ChipComponent value="basic">Basic</ChipComponent>
            <ChipComponent value="standard">Standard</ChipComponent>
            <ChipComponent value="premium">Premium</ChipComponent>
