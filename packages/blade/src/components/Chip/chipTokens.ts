...
const chipColorTokens: ChipColorTokens = {
  ...
  background: {
    ...
    positive: {
      default: 'feedback.positive.action.background.primary.default',
      hover: 'feedback.positive.action.background.primary.hover',
      disabled: 'brand.gray.a50.lowContrast',
    },
    negative: {
      default: 'feedback.negative.action.background.primary.default',
      hover: 'feedback.negative.action.background.primary.hover',
      disabled: 'brand.gray.a50.lowContrast',
    },
  },
  border: {
    ...
    positive: {
      default: 'feedback.positive.action.border.primary.default',
      hover: 'feedback.positive.action.border.primary.hover',
      disabled: 'brand.gray.a100.lowContrast',
    },
    negative: {
      default: 'feedback.negative.action.border.primary.default',
      hover: 'feedback.negative.action.border.primary.hover',
      disabled: 'brand.gray.a50.lowContrast',
    },
  },
};
