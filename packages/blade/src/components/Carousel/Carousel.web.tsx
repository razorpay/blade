...
const _Carousel = (
  ...
  React.useEffect(() => {
    ...
    const handleScroll = debounce(() => {
      ...
      // During a programmatic scroll (e.g. navigation button click, indicator click, or autoplay),
      // Firefox fires scroll events while the smooth scroll animation is in progress.
      // The scroll handler must not overwrite activeSlide with intermediate slide positions,
      // as this causes navigation buttons to flicker and onChange to fire with wrong indices.
