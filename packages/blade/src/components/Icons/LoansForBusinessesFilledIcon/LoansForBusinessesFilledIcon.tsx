...
const _LoansForBusinessesFilledIcon: IconComponent = ({
  size,
  color,
  ...styledProps
}) => {
...
const LoansForBusinessesFilledIcon = assignWithoutSideEffects(
  _LoansForBusinessesFilledIcon,
  {
    componentId: 'LoansForBusinessesFilledIcon',
  }
);

export default LoansForBusinessesFilledIcon;
