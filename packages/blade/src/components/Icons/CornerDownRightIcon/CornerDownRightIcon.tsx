...
const _CornerDownRightIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const CornerDownRightIcon = assignWithoutSideEffects(_CornerDownRightIcon, {
  componentId: 'CornerDownRightIcon',
});
