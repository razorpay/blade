...
export { default as TransactionsV1Icon } from './TransactionsV1Icon';
export { default as TransactionsV2Icon } from './TransactionsV2Icon';
...
export { default as RoutesV1Icon } from './RoutesV1Icon';
export { default as RoutesV2Icon } from './RoutesV2Icon';
export { default as SubscriptionsIcon } from './SubscriptionsIcon';
export { default as SmartCollectV1Icon } from './SmartCollectV1Icon';
