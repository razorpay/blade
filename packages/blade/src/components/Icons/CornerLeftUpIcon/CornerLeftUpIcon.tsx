...
const _CornerLeftUpIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const CornerLeftUpIcon = assignWithoutSideEffects(_CornerLeftUpIcon, {
  componentId: 'CornerLeftUpIcon',
});
