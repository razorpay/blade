...
const _LeftCircularCornerIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const LeftCircularCornerIcon = assignWithoutSideEffects(_LeftCircularCornerIcon, {
  componentId: 'LeftCircularCornerIcon',
});
