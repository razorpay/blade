...
const _MoreHorizontalIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const MoreHorizontalIcon = assignWithoutSideEffects(_MoreHorizontalIcon, {
  componentId: 'MoreHorizontalIcon',
});
