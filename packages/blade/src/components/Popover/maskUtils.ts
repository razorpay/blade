...
export function bestPositionOf(positions: PositionsObjectType, filters: string[] = []): string[] {
...
export function getPadding(padding: number | number[] = defaultPadding): number[] {
