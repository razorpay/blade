...
import { safe, getWindow, getPadding } from './maskUtils';
import { stylesMatcher } from './maskStyles';
...
const Mask: React.FC<MaskProps> = ({
  ...
  return (
    <div style={getStyles('maskWrapper', {})} onClick={onClick} className={className}>
      <svg
        width={windowWidth}
        height={windowHeight}
