...
const getAllProps = (
  ...
  return {
    ...
    marginBottom: getSpacingValue(props.marginBottom ?? props.marginY, props.theme, size),
    marginTop: getSpacingValue(props.marginTop ?? props.marginY, props.theme, size),
    marginRight: getSpacingValue(props.marginRight ?? props.marginX, props.theme, size),
    marginLeft: getSpacingValue(props.marginLeft ?? props.marginX, props.theme, size),
