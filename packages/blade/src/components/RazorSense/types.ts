...
// RIPPLE WAVE CONFIG
// ============================================
type RzpGlassRippleConfig = {
  /** Enable the procedural four-way ripple wave effect (default: false) */
  enableRippleWave?: boolean;
  /** Ring expansion duration in seconds (default: 1.2) */
  rippleSpeed?: number;
  /** Gaussian ring thickness (default: 0.08) */
  rippleBlend?: number;
  /** Sharpness of the four-way diagonal lobes (default: 4.0) */
  rippleAngularPower?: number;
  /** Max radius a ring expands to in UV space (default: 0.6) */
  rippleRadialFalloff?: number;
  /** Silence duration between bursts in seconds (default: 0.8) */
  rippleWaitTime?: number;
};
...
type RzpGlassProps = RzpGlassConfig & {
   ...
   * When provided, this path is used to construct URLs for default video, images, and gradient maps.
   * e.g. `cdnPath="https://cdn.example.com/assets"`
   */
  cdnPath?: string;
