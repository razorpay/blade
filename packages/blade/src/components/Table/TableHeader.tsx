    ...
    <SortButton {...makeAccessible({ label: 'Toggle Sort', role: 'button' })} onClick={onClick}>
      <svg width={20} height={20} fill="none">
        <path
          fill={upArrowColor}
          fillRule="evenodd"
          d="M13.354 7.854a.5.5 0 0 1-.708 0L10 5.207 7.354 7.854a.5.5 0 1 1-.708-.708l3-3a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708Z"
          clipRule="evenodd"
        />
        <path
          fill={downArrowColor}
          fillRule="evenodd"
          d="M6.646 12.146a.5.5 0 0 1 .708 0L10 14.793l2.646-2.647a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 0 1 0-.708Z"
          clipRule="evenodd"
        />
      </svg>
    </SortButton>
