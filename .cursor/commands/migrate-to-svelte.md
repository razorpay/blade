...
1. `.cursor/skills/migrate-to-svelte/SKILL.md`
...
1. Check against the workarounds list in `.cursor/skills/migrate-to-svelte/SKILL.md` — skip deps with known workarounds
