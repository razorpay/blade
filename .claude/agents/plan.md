...
- **`Worktree`**: absolute path to the component's git worktree (e.g., `/Users/.../blade/.claude/worktrees/Alert`)
...
- `{Worktree}/.claude/artifacts/{Name}/discovery-report.md` (template: `{Worktree}/.claude/templates/discovery-report.md`)
- `{Worktree}/.claude/artifacts/{Name}/migration-plan.md` (template: `{Worktree}/.claude/templates/migration-plan.md`)
- Examples: `{Worktree}/.claude/examples/badge-{discovery-report,migration-plan}.md`
...
Fill `{Worktree}/.claude/templates/discovery-report.md` with data from Part A. Save to `{Worktree}/.claude/artifacts/{Name}/discovery-report.md`.

### 15. Write migration plan

Fill `{Worktree}/.claude/templates/migration-plan.md` with decisions from Part B. Save to `{Worktree}/.claude/artifacts/{Name}/migration-plan.md`.
